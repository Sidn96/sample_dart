...
abstract class DateHelper {
  ...
  ///eg. isoDate - 2024-05-07T07:41:22.545Z
  ///eg. format - 'dd MMM yyyy'
  ///output - '07 May 2024'
  static String convertIsoDateToOtherFormat(DateTime isoDate, String format) {
    //DateTime now = DateTime.parse(isoDate);
    var formatter = DateFormat(format);
    var formatted = formatter.format(isoDate);
    return formatted;
  }
}
