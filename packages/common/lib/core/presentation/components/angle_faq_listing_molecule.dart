...
class Care100FaqSection extends HookConsumerWidget {
  const Care100FaqSection({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, ref) {
    final listOfHeaderContent = ref.read(listOfAngelHeaderContentProvider);
    final listOfExpandedContent = ref.read(listOfAngelContentProvider);
