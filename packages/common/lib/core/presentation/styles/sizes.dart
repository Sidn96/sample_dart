...
abstract class Sizes {
  ...
  static double screenWidth() {
    if (MediaQueryData.fromWindow(window).size.width >= 420) {
      return 420;
    } else {
  ...
  static const double defaultTextSize = textSize12;
  static const double normalTextSize = textSize14;
  ...
  //Hint
  static const double textFieldHintTextSize = 12;
  static const double textFieldLabelTextSize = 16;
