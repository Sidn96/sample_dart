...
class CouponClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.arcToPoint(bottomRightArc,
        radius: arcRadius, clockwise: endClockwise ? true : clockwise);
