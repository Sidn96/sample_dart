...
import '../utils/otp_field_style.dart';
...
class OTPTextFieldState extends State<OTPTextField> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        onChanged: (String str) {
          // LogUtils.instance.printLog('OTPField onChanged $str $index');
          if (str.length > 1) {
            _handlePaste(str);
            return;
          }
          ...
          if (str.isEmpty) {
            // LogUtils.instance.printLog('OTPField 1');
            if (index == 0) return;
          ...
          // LogUtils.instance.printLog('OTPField 11');
          // Remove focus
          ...
          // LogUtils.instance.printLog('OTPField 2 ${widget.onChanged}');
  ...
  void _handlePaste(String str) {
    debugPrint('OTPField _handlePaste $str');
